...
function StatusItem({ to, icon, label, code, dotColor }) {
  return (
    ...
    >
      {icon}
      <span className="flex-1">{label}</span>
      <span className="text-[11px] mr-2" style={{ color: C.muted }}>
        {code}
      </span>
      <span
    ...
    >
      <div>
        ...
        <div className="flex items-center gap-3 px-2 mb-7">
          ...
          <div>
            <p
              className="font-['Playfair_Display'] font-semibold text-[20px] leading-none tracking-[-0.01em]"
              style={{ color: C.deeper }}
            >
              Bloom
              <em
                className="not-italic font-['Playfair_Display'] italic font-medium"
                style={{ color: C.bloom }}
              >
                Bites
              </em>
            ...
            <p
              className="text-[10px] font-medium uppercase tracking-[0.1em] mt-0.5"
              style={{ color: C.faint }}
            >
              Admin Portal
            </p>
      ...
      <div>
        {/* CTA Card */}
        <div
          className="rounded-[14px] p-[18px] mb-4 relative overflow-hidden"
          style={{ background: C.deeper }}
        >
          <div
          ...
          />
          <p
            className="text-[12.5px] leading-relaxed mb-[14px] relative z-10"
            style={{ color: "#d4dcb8" }}
          >
        ...
        {/* Footer */}
        <div className="px-1">
          <p className="text-[11.5px] font-medium" style={{ color: C.faint }}>
            BloomBites Admin
          </p>
